...
# ## ML-Agents Learning (POCA2TEST)
# Contains an implementation of MA-POCA2TEST.
...
from mlagents.trainers.poca2test.optimizer_torch import TorchPOCA2TestOptimizer, POCA2TestSettings
...
TRAINER_NAME = "poca2test"


class POCA2TestTrainer(OnPolicyTrainer):
    """The POCA2TESTTrainer is an implementation of the MA-POCA2TEST algorithm."""
    ...
    def __init__(
        ...
        """
        Responsible for collecting experiences and training POCA2TEST model.
        ...
        self.hyperparameters: POCA2TestSettings = cast(
            POCA2TestSettings, self.trainer_settings.hyperparameters
        )
        self.seed = seed
        self.policy: TorchPolicy = None  # type: ignore
        self.optimizer: TorchPOCA2TESTOptimizer = None  # type: ignore
    ...
    def end_episode(self) -> None:
        ...
        Get only called when the academy resets. For POCA2TEST, we should
    ...
    def create_policy(
        ...
        """
        Creates a policy with a PyTorch backend and POCA2TEST hyperparameters
    ...
    def create_optimizer(self) -> TorchPOCA2TestOptimizer:
        return TorchPOCA2TestOptimizer(self.policy, self.trainer_settings)
