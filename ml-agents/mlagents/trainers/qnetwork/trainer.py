...
from mlagents.trainers.ppo.optimizer_torch import TorchQNetOptimizer, QNetSettings
...
class QNetTrainer(OnPolicyTrainer):
    ...
    def __init__(
        ...
        self.hyperparameters: QNetSettings = cast(
            QNetSettings, self.trainer_settings.hyperparameters
        )
        self.seed = seed
    ...
    def create_optimizer(self) -> TorchOptimizer:
        return TorchQNetOptimizer(  # type: ignore
